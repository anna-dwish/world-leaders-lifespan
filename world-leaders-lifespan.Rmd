...
leaders_model_V1 <- function() {
  ...
  beta_Obama <- beta_0 + beta_1*time_Obama + beta_type[type_Obama] + beta_int[type_Obama]*time_Obama
  mu_Obama <- exp(beta_Obama)
  survival_Obama ~ dweib(r, mu_Obama) %_% T(present_length_Obama, upper_length)
  
  beta_Naruhito <- beta_0 + beta_1*time_Naruhito + beta_type[type_Naruhito] + beta_int[type_Naruhito]*time_Naruhito
