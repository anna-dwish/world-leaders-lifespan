...
Bayesian_Leaders$BUGSoutput$sims.matrix %>% 
  as.data.frame() %>% 
  mutate(i = row_number()) %>% 
...
Bayesian_Leaders$BUGSoutput$sims.matrix[, "survival_Francis"] %>% hist() # this kinda makes sense?? I guess we wnat things to look "approx normal"
```
