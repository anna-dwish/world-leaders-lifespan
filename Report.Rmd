...
```{r fig.width=12, fig.align='center', eval=FALSE}
...
These out-of-sample predictions are of somewhat high quality. The blue line indicates the leader's age at death, while the solid red line indicates the posterior median lifespan with corresponding 95% credible intervals shown by the dotted red lines. Both of the leader's true age at death is captured between the median and the 97.5% quantile, with the posterior predictions for Sun doing better than that of Churchill's. This may because the model does not have a $type$ category for UK Prime Ministers and that Churchill lived longer than a majority of US Presidents. (idk  if this makes sense)
