...
load("leaders_model_r_1_beta_1.Rdata")
...
```{r}
tidybayes::gather_draws(Bayesian_Leader_output %>% coda::as.mcmc(), r, beta_0, beta_1) %>%  
...
survival_DL <- Bayesian_Leader_output$BUGSoutput$sims.matrix[,"survival_DL"]
survival_Francis <- Bayesian_Leader_output$BUGSoutput$sims.matrix[,"survival_Francis"]
...
survival_Obama <- Bayesian_Leader_output$BUGSoutput$sims.matrix[,"survival_Obama"]
survival_Naruhito <- Bayesian_Leader_output$BUGSoutput$sims.matrix[,"survival_Naruhito"]
