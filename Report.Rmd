...
Figure 1 displays lifespan across different leadership types. Among the Chinese Emperors, Japanese Emperors, and Dalai Lamas, the interquartile ranges of lifespan largely overlap. Additionally, Popes and U.S. presidents appear to have a slightly higher median lifespan relative to Chinese Emperors and Dalai Lamas. 
...
Our prior on $r$ was informed by the context of the study. Values of $r$ between 0 and 1 indicate a decreasing rate of failure over time, while those greater than 1 represent an increasing rate of failure. Because it can be assumed that the rate of death for world leaders increases with age, we want an $r$ value greater than 1. This warranted an informative $\Gamma(25, 0.2)$ prior with mean 5 and variance 1, reflecting our certainty of $r$ being a value greater than 1. We perform sensitivity analysis, along with other model diagnostics, in Section 4.2.2. 
...
Let $pope_i$ represent a Pope born in the mean birth year of the dataset. Then, a Chinese Emperor with the same birth year has an expected predicted survival time that is 0.74 times as much as $pope_i$. Similarly, a Dalai Lama born in the same year will be expected to survive only 0.69 times as long as $pope_i$. For a Japanese emperor of mean birth year, expected survival time is 0.88 times that of $pope_i$. And finally, a U.S. President has an expected survival time that is 0.91 times as much of $pope_i$. These values indicate that, among all leaders with the mean birth year of the dataset, popes have the largest mean survival time. However, this statement does not generalize across birth year.
...
We will address the research objective of providing posterior predictions of the lifespans of living leaders. Table 3 displays these point and interval predictions. Since we set the upper bound of the truncated Weibull distribution to 110, we expected the upper tails of the 95% credible intervals to be near 110. This is the case for all the leaders except the 14th Dalai Lama, whose 97.5% quantile is 99.16. As previously discussed, there was a string of early deaths among Dalai Lamas in the 19th century, which may have impacted the posterior predictions for the 14th Dalai Lama. Furthermore, Dalai Lamas represent the smallest group of leadership type ($n = 14$), which limits these predictions. 

## Applications with Select Leaders 
