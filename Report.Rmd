...
Our prior on $r$ was informed by the context of the study. Values of $r$ between 0 and 1 indicate a decreasing rate of failure over time, while those greater than 1 represent an increasing rate of failure. Because it can be assumed that the rate of death for world leaders increases with age, we want an $r$ value greater than 1. This warranted an informative $\Gamma(10, 0.2)$ prior with mean 5 and variance 1, reflecting our certainty of $r$ being a value greater than 1. We perform sensitivity analysis, along with other model diagnostics, in Section 4.2.2. 
